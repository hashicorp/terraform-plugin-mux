...
func TestMuxServerStateStore_DeleteState(t *testing.T) {
	t.Parallel()
	...
	if !testServer1.DeleteStateCalled["test_statestore_server1"] {
		t.Errorf("expected test_statestore_server1 DeleteState to be called on server1")
	}

	if testServer2.DeleteStateCalled["test_statestore_server1"] {
	...
	if !testServer2.DeleteStateCalled["test_statestore_server2"] {
		t.Errorf("expected test_statestore_server2 DeleteState to be called on server2")
	}

	if testServer1.DeleteStateCalled["test_statestore_server2"] {
		t.Errorf("unexpected test_statestore_server2 DeleteState called on server1")
	}
}

...
func TestSchemaAttributeType(t *testing.T) {
	...
	for name, testCase := range testCases {
		...
		t.Run(name, func(t *testing.T) {
			...
			got := schemaAttributeType(testCase.schemaAttribute)
...
func TestSchemaBlockType(t *testing.T) {
	t.Parallel()
	...
	for name, testCase := range testCases {
		...
		t.Run(name, func(t *testing.T) {
			...
			got := schemaBlockType(testCase.schemaBlock)
...
func TestSchemaNestedBlockType(t *testing.T) {
	t.Parallel()
	...
	for name, testCase := range testCases {
		...
		t.Run(name, func(t *testing.T) {
			...
			got := schemaNestedBlockType(testCase.schemaNestedBlock)
...
func TestSchemaType(t *testing.T) {
	...
	for name, testCase := range testCases {
		...
		t.Run(name, func(t *testing.T) {
			...
			got := schemaType(testCase.schema)

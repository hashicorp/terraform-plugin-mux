...
func TestEquals(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		dynamicValue1 *tfprotov6.DynamicValue
		dynamicValue2 *tfprotov6.DynamicValue
		expected      bool
		expectedError error
	}{
		"all-missing": {
		...
		"missing-type": {
			schemaType: nil,
			dynamicValue1: tf6dynamicvalue.Must(
				tftypes.Object{
			...
			dynamicValue2: tf6dynamicvalue.Must(
				tftypes.Object{
					AttributeTypes: map[string]tftypes.Type{
						"test_string_attribute": tftypes.String,
					},
	...
	for name, testCase := range testCases {
		...
		t.Run(name, func(t *testing.T) {
			...
			got, err := tf6dynamicvalue.Equals(testCase.schemaType, testCase.dynamicValue1, testCase.dynamicValue2)
